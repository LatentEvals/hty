...
pub fn helpText() []const u8 {
    ...
    \\structured response (both uncollapsed), or --meta for just the
    \\metadata (cursor position, screen size, session status) without the
    \\screen buffer. --meta cannot be combined with --ansi, --json, or
    \\--lines.
    \\
