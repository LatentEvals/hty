...
When you attach, hty automatically resizes the PTY to match your terminal dimensions.

Press **Ctrl+A d** to detach (tmux-style). This disconnects your client but does not kill the session. **Ctrl+A Ctrl+A** sends a literal Ctrl+A to the program.
