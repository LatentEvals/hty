...
You should see the hty command list. If you get `command not found`, check that the install directory is on your `PATH`. Head to [Quick Start](/quickstart) to run your first session.
